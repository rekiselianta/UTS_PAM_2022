...
const App = () => {
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="Beranda" component={Home} options={({ navigation, route }) => ({
          headerRight: props => <Menu navigation={navigation} {...props} />,

        })} />
        <Stack.Screen name="Pesanan saya" component={ListTiket} options={({ navigation, route }) => ({
          headerRight: props => <Menu navigation={navigation} {...props} />,
          headerTitle: ''
        ...
        <Stack.Screen name="Pembatalan" component={OrderListCancel} options={({ navigation, route }) => ({
          headerRight: props => <Menu navigation={navigation} {...props} />,
          headerTitle: ''
